  ...
  function addRichMarker(){
    ...
    var htm1 =
      ...
      "<img style='margin-left:9px;margin-top: 8px;' src='http://bj.bcebos.com/v1/mapopen/github/BMapGLLib/RichMarker/examples/images/small.jpg' />" +
      "</div>",
    ...
    myRichMarker2.addEventListener("onmouseover", function (e) {
      document.getElementById("rm3_image").src = "http://bj.bcebos.com/v1/mapopen/github/BMapGLLib/RichMarker/examples/images/back2.png";
    });
    myRichMarker2.addEventListener("onmouseout", function (e) {
      document.getElementById("rm3_image").src = "http://bj.bcebos.com/v1/mapopen/github/BMapGLLib/RichMarker/examples/images/back1.png";
    });
  ...
  function addInfoBox(){
    ...
    var html = [
      ...
      "<div class='list'><ul><li><div class='left'><img src='../img/gl/wucaicheng.jpg'/></div><div class='left'><a target='_blank' href='http://map.baidu.com'>中海雅园南北通透四居室</a><p>4室2厅，205.00平米，3层</p></div><div class='rmb'>760万</div></li>",
      "<li><div class='left'><img src='../img/gl/wucaicheng.jpg'/></div><div class='left'><a target='_blank' href='http://map.baidu.com'>中海雅园四居室还带保姆间</a><p>2室1厅，112.00平米，16层</p></div><div class='rmb'>300万</div></li>",
      "<li><div class='left'><img src='../img/gl/wucaicheng.jpg'/></div><div class='left'><a target='_blank' href='http://map.baidu.com'>《有钥匙 随时看》花园水系</a><p>3室2厅，241.00平米，16层</p></div><div class='rmb'>400万</div></li>",
      "<li><div class='left'><img src='../img/gl/wucaicheng.jpg'/></div><div class='left'><a target='_blank' href='http://map.baidu.com'>富力城D区正规楼王大三居</a><p>3室3厅，241.00平米，17层</p></div><div class='rmb'>600万</div></li>",
      "<li class='last'><div class='left'><img src='../img/gl/wucaicheng.jpg'/></div><div class='left'><a target='_blank' href='http://map.baidu.com'>富力城豪，身份人士的象征</a><p>4室2厅，213.90平米，25层</p></div><div class='rmb'>700万</div></li>",
      "</ul></div>", "</div>"
    ];
    var infoBox = new BMapGLLib.InfoBox(map, html.join(""), {
      ...
      closeIconUrl: 'http://mapopen.bj.bcebos.com/github/BMapGLLib/InfoBox/examples/images/close.png',
      enableAutoPan: true,
